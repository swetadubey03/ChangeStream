...
const getUser = asyncHandler(async(req,res) =>{
    ...
    //Used $Lookup
    // const joinedOrder = await Orders.aggregate()
    
   await Orders.aggregate([{$lookup: {from: "Users", localField: "personName", 
     foreignField: "firstName", as :"Used Lookup"}}]).exec((err, data)=>{
        if(err){
